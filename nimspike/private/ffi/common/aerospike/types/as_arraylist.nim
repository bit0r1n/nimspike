...
proc as_arraylist_get_integer*(list: ptr as_arraylist, index: uint32): ptr as_integer {.importc, header: asArrayListHeader.}
proc as_arraylist_get_as_double*(list: ptr as_arraylist, index: uint32): ptr as_double {.importc, header: asArrayListHeader.}
proc as_arraylist_get_string*(list: ptr as_arraylist, index: uint32): ptr as_string {.importc, header: asArrayListHeader.}
proc as_arraylist_get_bytes*(list: ptr as_arraylist, index: uint32): ptr as_bytes {.importc, header: asArrayListHeader.}
proc as_arraylist_get_list*(list: ptr as_arraylist, index: uint32): ptr as_list {.importc, header: asArrayListHeader.}
proc as_arraylist_get_map*(list: ptr as_arraylist, index: uint32): ptr as_map {.importc, header: asArrayListHeader.}
...
proc as_arraylist_set_integer*(list: ptr as_arraylist, index: uint32, value: ptr as_integer): cint {.importc, header: asArrayListHeader.}
proc as_arraylist_set_as_double*(list: ptr as_arraylist, index: uint32, value: ptr as_double): cint {.importc, header: asArrayListHeader.}
proc as_arraylist_set_string*(list: ptr as_arraylist, index: uint32, value: ptr as_string): cint {.importc, header: asArrayListHeader.}
proc as_arraylist_set_bytes*(list: ptr as_arraylist, index: uint32, value: ptr as_bytes): cint {.importc, header: asArrayListHeader.}
proc as_arraylist_set_list*(list: ptr as_arraylist, index: uint32, value: ptr as_list): cint {.importc, header: asArrayListHeader.}
proc as_arraylist_set_map*(list: ptr as_arraylist, index: uint32, value: ptr as_map): cint {.importc, header: asArrayListHeader.}
...
proc as_arraylist_insert_integer*(list: ptr as_arraylist, index: uint32, value: ptr as_integer): cint {.importc, header: asArrayListHeader.}
proc as_arraylist_insert_as_double*(list: ptr as_arraylist, index: uint32, value: ptr as_double): cint {.importc, header: asArrayListHeader.}
proc as_arraylist_insert_string*(list: ptr as_arraylist, index: uint32, value: ptr as_string): cint {.importc, header: asArrayListHeader.}
proc as_arraylist_insert_bytes*(list: ptr as_arraylist, index: uint32, value: ptr as_bytes): cint {.importc, header: asArrayListHeader.}
proc as_arraylist_insert_list*(list: ptr as_arraylist, index: uint32, value: ptr as_list): cint {.importc, header: asArrayListHeader.}
proc as_arraylist_insert_map*(list: ptr as_arraylist, index: uint32, value: ptr as_map): cint {.importc, header: asArrayListHeader.}
...
proc as_arraylist_append_integer*(list: ptr as_arraylist, value: ptr as_integer): cint {.importc, header: asArrayListHeader.}
proc as_arraylist_append_as_double*(list: ptr as_arraylist, value: ptr as_double): cint {.importc, header: asArrayListHeader.}
proc as_arraylist_append_string*(list: ptr as_arraylist, value: ptr as_string): cint {.importc, header: asArrayListHeader.}
proc as_arraylist_append_bytes*(list: ptr as_arraylist, value: ptr as_bytes): cint {.importc, header: asArrayListHeader.}
proc as_arraylist_append_list*(list: ptr as_arraylist, value: ptr as_list): cint {.importc, header: asArrayListHeader.}
proc as_arraylist_append_map*(list: ptr as_arraylist, value: ptr as_map): cint {.importc, header: asArrayListHeader.}
...
proc as_arraylist_prepend_integer*(list: ptr as_arraylist, value: ptr as_integer): cint {.importc, header: asArrayListHeader.}
proc as_arraylist_prepend_as_double*(list: ptr as_arraylist, value: ptr as_double): cint {.importc, header: asArrayListHeader.}
proc as_arraylist_prepend_string*(list: ptr as_arraylist, value: ptr as_string): cint {.importc, header: asArrayListHeader.}
proc as_arraylist_prepend_bytes*(list: ptr as_arraylist, value: ptr as_bytes): cint {.importc, header: asArrayListHeader.}
proc as_arraylist_prepend_list*(list: ptr as_arraylist, value: ptr as_list): cint {.importc, header: asArrayListHeader.}
proc as_arraylist_prepend_map*(list: ptr as_arraylist, value: ptr as_map): cint {.importc, header: asArrayListHeader.}
