...
proc as_map_destroy*(map: ptr as_map): void {.importc, header: asMapHeader.}

proc as_map_hashcode*(map: ptr as_map): uint32 {.importc, header: asMapHeader.}
proc as_map_size*(map: ptr as_map): uint32 {.importc, header: asMapHeader.}

proc as_map_get*(map: ptr as_map, key: ptr as_val): ptr as_val {.importc, header: asMapHeader.}
proc as_map_set*(map: ptr as_map, key: ptr as_val, val: ptr as_val): cint {.importc, header: asMapHeader.}
proc as_map_clear*(map: ptr as_map): cint {.importc, header: asMapHeader.}
proc as_map_remove*(map: ptr as_map, key: ptr as_val): cint {.importc, header: asMapHeader.}
proc as_map_set_flags*(map: ptr as_map, flags: uint32): void {.importc, header: asMapHeader.}

proc as_map_foreach*(map: ptr as_map, callback: as_map_foreach_callback, udata: pointer): bool {.importc, header: asMapHeader.}
proc as_map_iterator_new*(map: ptr as_map): ptr as_map_iterator {.importc, header: asMapHeader.}
proc as_map_iterator_init*(it: ptr as_map_iterator, map: ptr as_map): ptr as_map_iterator {.importc, header: asMapHeader.}
proc as_map_toval*(map: ptr as_map): ptr as_val {.importc, header: asMapHeader.}
proc as_map_fromval*(val: ptr as_val): ptr as_map {.importc, header: asMapHeader.}
