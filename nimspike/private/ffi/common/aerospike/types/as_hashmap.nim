...
const asHashmapHeader = "aerospike/as_hashmap.h"

type as_hashmap* = as_orderedmap

proc as_hashmap_init*(map: ptr as_hashmap, capacity: uint32): ptr as_hashmap {.importc, header: asHashmapHeader.}
proc as_hashmap_new*(capacity: uint32): ptr as_hashmap {.importc, header: asHashmapHeader.}
let as_hashmap_destroy* = as_orderedmap_destroy

let as_hashmap_size* = as_orderedmap_size
proc as_hashmap_hashcode*(map: ptr as_hashmap): uint32 {.importc, header: asHashmapHeader.}
