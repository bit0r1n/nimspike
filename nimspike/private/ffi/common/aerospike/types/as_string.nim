...
proc as_string_destroy*(str: ptr as_string): void {.importc, header: asStringHeader.}

proc as_string_len*(str: ptr as_string): csize_t {.importc, dynlib: asLibName.}
proc as_string_getorelse*(str: ptr as_string, fallback: cstring): cstring {.importc, header: asStringHeader.}
proc as_string_get*(str: ptr as_string): cstring {.importc, header: asStringHeader.}
proc as_string_tostring*(str: ptr as_string): cstring {.importc, header: asStringHeader.}
proc as_basename*(filename: ptr as_string, path: cstring): cstring {.importc, dynlib: asLibName.}

proc as_string_toval*(str: ptr as_string): ptr as_val {.importc, header: asStringHeader.}
proc as_string_fromval*(v: ptr as_val): ptr as_string {.importc, header: asStringHeader.}
...
proc as_strncpy*(trg: ptr UncheckedArray[char], src: cstring, size: int): bool {.importc, dynlib: asLibName.}
