...
proc as_geojson_destroy*(str: ptr as_geojson): void {.importc, dynlib: asLibName.}

proc as_geojson_len*(str: ptr as_geojson): csize_t {.importc, dynlib: asLibName.}
proc as_geojson_getorelse*(str: ptr as_geojson, fallback: cstring): cstring {.importc, dynlib: asLibName.}
proc as_geojson_get*(str: ptr as_geojson): cstring {.importc, dynlib: asLibName.}

proc as_geojson_toval*(str: ptr as_geojson): ptr as_val {.importc, dynlib: asLibName.}
proc as_geojson_fromval*(v: ptr as_val): ptr as_geojson {.importc, dynlib: asLibName.}
