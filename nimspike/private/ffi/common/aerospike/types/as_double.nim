...
proc as_double_destroy*(value: ptr as_double): void {.importc, header: asDoubleHeader.}

proc as_double_getorelse*(value: ptr as_double, fallback: cdouble): cdouble {.importc, header: asDoubleHeader.}
proc as_double_get*(value: ptr as_double): cdouble {.importc, header: asDoubleHeader.}

proc as_double_toval*(value: ptr as_double): ptr as_val {.importc, header: asDoubleHeader.}
proc as_double_fromval*(v: ptr as_val): ptr as_double {.importc, header: asDoubleHeader.}
