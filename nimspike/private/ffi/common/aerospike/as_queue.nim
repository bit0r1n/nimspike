...
proc as_queue_size*(queue: ptr as_queue): uint32 {.importc, header: asQueueHeader.}
proc as_queue_empty*(queue: ptr as_queue): bool {.importc, header: asQueueHeader.}
...
proc as_queue_get*(queue: ptr as_queue, index: uint32): pointer {.importc, header: asQueueHeader.}
proc as_queue_pop*(queue: ptr as_queue, `ptr`: pointer): bool {.importc, header: asQueueHeader.}
proc as_queue_pop_tail*(queue: ptr as_queue, `ptr`: pointer): bool {.importc, header: asQueueHeader.}
proc as_queue_incr_total*(queue: ptr as_queue): void {.importc, header: asQueueHeader.}
proc as_queue_decr_total*(queue: ptr as_queue): void {.importc, header: asQueueHeader.}