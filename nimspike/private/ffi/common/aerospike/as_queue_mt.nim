...
proc as_queue_mt_destroy*(queue: ptr as_queue_mt): void {.importc, dynlib: asLibName.}
proc as_queue_mt_size*(queue: ptr as_queue_mt): uint32 {.importc, dynlib: asLibName.}
proc as_queue_mt_empty*(queue: ptr as_queue_mt): bool {.importc, dynlib: asLibName.}
proc as_queue_mt_push*(queue: ptr as_queue_mt, `ptr`: pointer): bool {.importc, dynlib: asLibName.}
proc as_queue_mt_push_limit*(queue: ptr as_queue_mt, `ptr`: pointer): bool {.importc, dynlib: asLibName.}
proc as_queue_mt_push_head*(queue: ptr as_queue_mt, `ptr`: pointer): bool {.importc, dynlib: asLibName.}
proc as_queue_mt_push_head_limit*(queue: ptr as_queue_mt, `ptr`: pointer): bool {.importc, dynlib: asLibName.}
