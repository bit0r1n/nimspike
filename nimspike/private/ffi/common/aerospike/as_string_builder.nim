...
proc as_string_builder_assign*(sb: ptr as_string_builder, buffer_size: uint32, data: cstring): void {.importc, dynlib: asLibName.}
proc as_string_builder_destroy*(sb: ptr as_string_builder): void {.importc, dynlib: asLibName.}
proc as_string_builder_reset*(sb: ptr as_string_builder): void {.importc, dynlib: asLibName.}
...
proc as_string_builder_append_newline*(sb: ptr as_string_builder): bool {.importc, dynlib: asLibName.}